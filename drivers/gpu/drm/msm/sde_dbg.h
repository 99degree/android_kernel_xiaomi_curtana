...
static inline int sde_dbg_reg_register_cb(const char *name, void (*cb)(void *), void *ptr) {
	return 0;
}
...
static inline int sde_dbg_debugfs_register(struct device * dummy)
{
	return 0;
}
...
static inline void sde_dbg_dump(enum sde_dbg_dump_context dummy,
	const char *name, ...)
{
}
